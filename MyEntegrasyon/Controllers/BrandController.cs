...
namespace MyEntegrasyon.Controllers
{
    public class BrandController : Controller
    {
        ...
        public BrandController(MyContext context, IConfiguration configuration, HttpClient httpClient)
        {
            _context = context;
        ...
        {
            List<ListProductBrand> BrandList = new List<ListProductBrand>();
            using (var client = new GraphQLHttpClient(_endPoind, new NewtonsoftJsonSerializer()))
            {
              ...
              + HttpUtility.UrlEncode(_clientId) + "&client_secret=" + HttpUtility.UrlEncode(_secret));
                ...
                BrandList = gelen_Brand.Data.listProductBrand!;
            }
